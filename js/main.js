...
$(".all-filter").click(function () {
    ...
    $("#filter-toggle").css('background', '#fff').css('color', '#384866');
});
...
$("#clear-filter").click(function () {
    $("#filter-toggle strong").html($("#filter-toggle strong").html() == 'Filter By Type' ? 'Filter By Type' : 'Filter By Type');
    $("#filter-toggle").css('background', '#fff').css('color', '#333');
});
